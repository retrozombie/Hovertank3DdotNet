...
{
    /// <summary>System implementation for Windows Forms.</summary>
    class WinFormsSys : Sys
    {
        /// <summary>Creates a new WinFormsSys.</summary>
        /// <param name="commandLineArguments">The command line arguments.</param>
        public WinFormsSys(string[] commandLineArguments)
