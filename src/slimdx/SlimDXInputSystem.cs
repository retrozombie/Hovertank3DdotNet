...
{
    /// <summary>SlimDX input system implementation.</summary>
    class SlimDXInputSystem : InputSystem
    {
        ...
        private void UpdateKeyboard()
        {
            ...
            for(int i = 0; i < _keyboardState.ReleasedKeys.Count; i++)
                if((scanCode = _keyToScanCode[(int) _keyboardState.ReleasedKeys[i]]) != 0)
        ...
        private void UpdateJoystick()
        {
            ...
            for(int i = 0, value = 1; i < 2; i++, value <<= 1)
